...
const WhySouthBay = () => (
  <Container style={{fontSize: '1.3em', padding: '5em'}}>
    <Grid columns={2} style={{backgroundImage: `url(${palms})`, backgroundSize: 'cover', backgroundPosition: 'center center', backgroundAttachment: 'fixed'}}>
      <Grid.Row style={{height: '35vh', padding: '0'}}>
        <Grid.Column className='animated fadeInLeft' style={{color: 'white', border: '5px solid white', padding: '0', backgroundColor: 'rgba(255,0,0,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
        ...
        <Grid.Column className='animated fadeInDown' style={{color: 'white', border: '5px solid white', padding: '0', backgroundColor: 'rgba(255,0,0,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
      ...
      <Grid.Row style={{height: '35vh', padding: '0'}}>
        <Grid.Column className='animated fadeInUp' style={{color: 'white', border: '5px solid white', padding: '0', backgroundColor: 'rgba(255,0,0,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
        ...
        <Grid.Column className='animated fadeInRight' style={{color: 'white', border: '5px solid white', padding: '0', backgroundColor: 'rgba(255,0,0,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
