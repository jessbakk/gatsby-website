  ...
  <Container style={{fontSize: '1.3em', padding: '5em'}}>
    <Grid columns={2} style={{border: '5px solid white'}}>
      <Grid.Row style={{height: '35vh', borderBottom: '5px solid white', padding: '0'}}>
        ...
        <Grid.Column className='animated fadeInDown' style={{color: 'white', borderLeft: '5px solid white', padding: '0', backgroundColor: 'rgba(255,0,0,.5)', animationDuration: '.5s'}}>
      ...
      <Grid.Row style={{height: '35vh', borderTop: '5px solid white', padding: '0'}}>
        <Grid.Column className='animated fadeInUp' style={{color: 'white', borderRight: '5px solid white', padding: '0', backgroundColor: 'rgba(255,0,0,.5)', animationDuration: '.5s'}}>
        ...
        <Grid.Column className='animated fadeInUp' style={{color: 'white', borderLeft: '5px solid white', padding: '0', backgroundColor: 'rgba(255,0,0,.5)', animationDuration: '.5s'}}>
