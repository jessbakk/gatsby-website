...
const Criteria = () => (
  <Grid.Column width={12}>
    ...
    <p>Upon hitting or exceeding our Value Add Target we typically either exit the market or 1031 exchange into another underperforming asset with good upside potential.</p>
    <p>Our group has an impeccable reputation for closing deals and greatly leverage that reputation to insure the best terms and the lowest price</p>
  </Grid.Column>
)
