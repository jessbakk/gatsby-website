  ...
  <Container style={{fontSize: '1.3em', padding: '5em'}}>
    <Grid columns={2} style={{border: '5px solid white', backgroundImage: `url(${apartment})`, backgroundSize: 'cover', backgroundPosition: 'center center', backgroundAttachment: 'fixed'}}>
      <Grid.Row style={{height: '35vh', borderBottom: '5px solid white', padding: '0'}}>
        <Grid.Column className='animated fadeInDown' style={{color: 'white', borderRight: '5px solid white', padding: '0', backgroundColor: 'rgba(0,0,255,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
        ...
        <Grid.Column className='animated fadeInRight' style={{color: 'white', borderLeft: '5px solid white', padding: '0', backgroundColor: 'rgba(0,0,255,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
      ...
      <Grid.Row style={{height: '35vh', borderTop: '5px solid white', padding: '0'}}>
        <Grid.Column className='animated fadeInLeft' style={{color: 'white', borderRight: '5px solid white', padding: '0', backgroundColor: 'rgba(0,0,255,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
        ...
        <Grid.Column className='animated fadeInUp' style={{color: 'white', borderLeft: '5px solid white', padding: '0', backgroundColor: 'rgba(0,0,255,.5)', animationDuration: '.5s', animationDelay: '.2s'}}>
